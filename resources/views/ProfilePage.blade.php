...
<html lang="en">
  <head>
    ...
    <title>Profile - Smart Learning!.</title>
    <!-- CSS files -->
        ...
        <div class="page-header">
          <div class="container">
            <div class="row align-items-center">
              ...
              <div class="col">
                <h1 class="fw-bold">Nanda Yunan</h1>
                <div class="my-2">SMA VICTORY.
                </div>
                  ...
                  <li class="timeline-event">
                    ...
                    <div class="card timeline-event-card">
                      <div class="card-body">
                        ...
                        <h4> 3 Tugas belum dikerjakan</h4>
                        <p class="text-muted">Kerjakan sebelum tenggat!</p>
                      </div>
                    </div>
                  </li>
                  <li class="timeline-event">
                    ...
                    <div class="card timeline-event-card">
                      <div class="card-body">
                        ...
                        <h4>+3 Materi baru sudah diupload!</h4>
                        <p class="text-muted">Lihat dan pelajari materinya!</p>
                      </div>
                    </div>
                  </li>
                  <li class="timeline-event">
                    ...
                    <div class="card timeline-event-card">
                      <div class="card-body">
                        ...
                        <h4>2 tugas baru baru dikumpulkan!</h4>
                        <p class="text-muted">Terima kasih sudah mengumpulkan.</p>
                      </div>
                    </div>
                  </li>
                  <li class="timeline-event">
                    ...
                    <div class="card timeline-event-card">
                      <div class="card-body">
                        <div class="text-muted float-end">1 day ago</div>
                        <h4>30 hari menuju UAS</h4>
                        <p class="text-muted">Belajar lebih giat untuk mendapat nilai yang bagus!</p>
                      </div>
                    </div>
                  </li>
                  <!-- <li class="timeline-event">
                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="mb-2">
                          ...
                          Went to: <strong>SMA VICTORY!</strong>
                        </div>
                        <div class="mb-2">
                        ...
                        <!-- <div class="mb-2"> -->
                          ...
                          <svg xmlns="http://www.w3.org/2000/svg" class="icon me-2 text-muted" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M5 12l-2 0l9 -9l9 9l-2 0" /><path d="M5 12v7a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-7" /><path d="M9 21v-6a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v6" /></svg>
                          Lives in: <strong>DAGO, BANDUNG</strong>
                        </div>
                        <div class="mb-2">
                          <!-- Download SVG icon from http://tabler-icons.io/i/map-pin -->
                          <svg xmlns="http://www.w3.org/2000/svg" class="icon me-2 text-muted" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9 11a3 3 0 1 0 6 0a3 3 0 0 0 -6 0" /><path d="M17.657 16.657l-4.243 4.243a2 2 0 0 1 -2.827 0l-4.244 -4.243a8 8 0 1 1 11.314 0z" /></svg>
                          From: <strong><img src="dist/img/Indo.png" width ="34" height="20"></img>
                            INDONESIA</strong>
                        </div>
                        <div class="mb-2">
                          <!-- Download SVG icon from http://tabler-icons.io/i/calendar -->
                          <svg xmlns="http://www.w3.org/2000/svg" class="icon me-2 text-muted" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 7a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2v-12z" /><path d="M16 3v4" /><path d="M8 3v4" /><path d="M4 11h16" /><path d="M11 15h1" /><path d="M12 15v3" /></svg>
                          Birth date: <strong>7/8/2003</strong>
                        </div>
                        <div>
                          ...
                          Time zone: <strong>Indonesia WIB</strong>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="col-12 col-lg-auto mt-3 mt-lg-0">
                <ul class="list-inline list-inline-dots mb-0">
                  <li class="list-inline-item">
                    Copyright &copy; 2024
                    <a href="." class="link-secondary">Team VICTORY!</a>.
                    All rights reserved.
                  </li>
