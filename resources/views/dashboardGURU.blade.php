...
<div class="col-xl-3 col-md-6 mb-4 ">
    <div class="card border-left-success shadow h-100 py-2">
       <a href="{{ route('detailSiswa.index') }}" style="text-decoration:none;">
      <div class="card-body">
  ...
  <div class="col-xl-3 col-md-6 mb-4 ">
    ...
    <a href="{{ route('detailKelas.index') }}" style="text-decoration:none;">
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
  ...
  <div class="col-xl-3 col-md-6 mb-4 ">
    ...
    <a href="{{ route('detailMapel.index') }}" style="text-decoration:none;">
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
