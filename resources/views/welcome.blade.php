            ...
            <div class="row row-deck row-cards">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="subheader">Tugas Selesai</div>
                      <div class="ms-auto lh-1">
                        <div class="dropdown">
                          <a class="dropdown-toggle text-muted" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Last</a>
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="subheader">Grafik Raport</div>
                      <div class="ms-auto lh-1">
                        <div class="dropdown">
                          <a class="dropdown-toggle text-muted" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Semester</a>
                          <div class="dropdown-menu dropdown-menu-end">
                            <a class="dropdown-item active" href="#">Semester Ganjil</a>
                    ...
                    <div class="d-flex align-items-baseline">
                      <div class="h1 mb-0 me-2">80,45</div>
                      <div class="me-auto">
                        <span class="text-green d-inline-flex align-items-center lh-1">
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="subheader">Grafik Absen </div>
                      <div class="ms-auto lh-1">
                        <div class="dropdown">
                          <a class="dropdown-toggle text-muted" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Last</a>
                          <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <div class="d-flex align-items-baseline">
                      <div class="h1 mb-3 me-2">81,00</div>
                      <div class="me-auto">
                        <span class="text-green d-inline-flex align-items-center lh-1">
                          5% <!-- Download SVG icon from http://tabler-icons.io/i/minus -->
                          <svg xmlns="http://www.w3.org/2000/svg" class="icon ms-1" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M3 17l6 -6l4 4l8 -8" /><path d="M14 7l7 0l0 7" /></svg>
                      </div>
                    </div>
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="subheader">Keaktifan siswa</div>
                      <div class="ms-auto lh-1">
                        <div class="dropdown">
                          <a  href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></a>
                          <!-- <div class="dropdown-menu dropdown-menu-end">
                      ...
                      <div class="card-body card-body-scrollable card-body-scrollable-shadow">
                        <div class="divide-y">
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar">MTK</span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                                  <strong>Matematika</strong> telah memposting <strong>"Tugas 1"</strong>
                                </div>
                                <div class="text-muted">Kemarin</div>
                              </div>
                          ...
                          <div>
                            <div class="row">
                              ...
                              <div class="col">
                                <div class="text-truncate">
                                <strong>Bahasa Indonesia</strong> telah memposting <strong>"Tugas Harian"</strong>
                                </div>
                                <div class="text-muted">2 hari lalu</div>
                              </div>
                              <div class="col-auto align-self-center">
                                <div class="badge bg-primary"></div>
                              </div>
                          ...
                          <div>
                            <div class="row">
                              ...
                              <div class="col">
                                <div class="text-truncate">
                                <strong>Penjas</strong> telah memposting <strong>"Tugas Praktek"</strong>
                                </div>
                                <div class="text-muted">Baru saja</div>
                              </div>
                              <div class="col-auto align-self-center">
                                <div class="badge bg-primary"></div>
                              </div>
                          ...
                          <div>
                            <div class="row">
                              ...
                              <div class="col">
                                <div class="text-truncate">
                                <strong>Sejarah Indonesia</strong> telah memposting <strong>"Tugas 2"</strong>
                                </div>
                                <div class="text-muted">4 hari lalu</div>
                              </div>
                              <div class="col-auto align-self-center">
                                <div class="badge bg-primary"></div>
                              </div>
                          ...
                          <div>
                            <div class="row">
                              ...
                              <div class="col">
                                <div class="text-truncate">
                                <strong>PAI</strong> telah memposting <strong>"Tugas 2"</strong>
                                </div>
                                <div class="text-muted">2 hari lalu</div>
                              </div>
                            </div>
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar">PAI</span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                                <strong>Ekonomi</strong> telah memposting <strong>"Tugas 3"</strong>
                                </div>
                                <div class="text-muted">Kemarin</div>
                              </div>
                            </div>
                          ...
                          <div>
                            <div class="row">
                              ...
                              <div class="col">
                                <div class="text-truncate">
                                <strong>PKN</strong> telah memposting <strong>"Tugas 2"</strong>
                                </div>
                                <div class="text-muted">2 hari lalu</div>
                              </div>
                            </div>
                  ...
                  <div class="table-responsive">
                    <table class="table card-table table-vcenter">
                      <tr>
                        ...
                        <td class="w-100">
                          <a href="#" class="text-reset">Tugas Sejarah Indonesia.</a>
                        </td>
                      ...
                      <tr>
                        ...
                        <td class="w-100">
                          <a href="#" class="text-reset">Tugas Matematika.</a>
                        </td>
                        <td class="text-nowrap text-muted">
                          <!-- Download SVG icon from http://tabler-icons.io/i/calendar -->
                          <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 7a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2v-12z" /><path d="M16 3v4" /><path d="M8 3v4" /><path d="M4 11h16" /><path d="M11 15h1" /><path d="M12 15v3" /></svg>
                        ...
                        <td>
                          <span class="avatar avatar-sm">MTK</span>
                        </td>
                      </tr>
                      <tr>
                        <td class="w-1 pe-0">
                        ...
                        <td class="w-100">
                          <a href="#" class="text-reset">Tugas PKN </a>
                        </td>
                        <td class="text-nowrap text-muted">
                          <!-- Download SVG icon from http://tabler-icons.io/i/calendar -->
                          <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 7a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2v-12z" /><path d="M16 3v4" /><path d="M8 3v4" /><path d="M4 11h16" /><path d="M11 15h1" /><path d="M12 15v3" /></svg>
                      ...
                      <tr>
                        ...
                        <td class="w-100">
                          <a href="#" class="text-reset">Tugas Ekonomi</a>
                        </td>
                        <td class="text-nowrap text-muted">
                          <!-- Download SVG icon from http://tabler-icons.io/i/calendar -->
                          <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 7a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2v-12z" /><path d="M16 3v4" /><path d="M8 3v4" /><path d="M4 11h16" /><path d="M11 15h1" /><path d="M12 15v3" /></svg>
                      ...
                      <tr>
                        ...
                        <td class="w-100">
                          <a href="#" class="text-reset">Tugas PAI</a>
                        </td>
                        <td class="text-nowrap text-muted">
                          <!-- Download SVG icon from http://tabler-icons.io/i/calendar -->
                          <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 7a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2v-12z" /><path d="M16 3v4" /><path d="M8 3v4" /><path d="M4 11h16" /><path d="M11 15h1" /><path d="M12 15v3" /></svg>
                      ...
                      <tr>
                        ...
                        <td class="w-100">
                          <a href="#" class="text-reset">Tugas Penjas</a>
                        </td>
                        <td class="text-nowrap text-muted">
                          <!-- Download SVG icon from http://tabler-icons.io/i/calendar -->
                          <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 7a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2v-12z" /><path d="M16 3v4" /><path d="M8 3v4" /><path d="M4 11h16" /><path d="M11 15h1" /><path d="M12 15v3" /></svg>
